...
public class EPSApp extends JFrame {
    ...
    class LoginPanel extends JPanel {
        ...
        public LoginPanel(EPSApp app) {
            ...
            // Título bienvenido grande en blanco
            JLabel welcomeLabel = new JLabel("Bienvenido a TuEPS");
            ...
            try {
                ImageIcon logoIcon = new ImageIcon("logo_eps.png"); // Asegúrate de tener el logo_eps.png en la carpeta del proyecto
            ...
            gbc.gridx = 0; gbc.gridy = 4; formPanel.add(loginButton, gbc);
            gbc.gridx = 1; formPanel.add(toRegisterButton, gbc);
            gbc.gridx = 0; gbc.gridy = 5; gbc.gridwidth = 2; formPanel.add(messageLabel, gbc);
    ...
    class AppointmentPanel extends JPanel {
        ...
        public AppointmentPanel(EPSApp app) {
            ...
            // Colocar componentes con GridBagLayout
